...
class MyShipTracking extends Source{
    ...
    getLocation = async (mmsi:Number) =>{
      let result = await this.fetch("https://www.myshiptracking.com/vessels/mmsi-310627000",
      {
        ...
        "cookie": "usr_lang_exist=1; port_tz=LT; user_tz=MT; user_df=1; session_id_sp_trk=fd1i0pb2mt6i4nra9c1mejsmvk; offset=Europe%2FBerlin; usr_lang_exist=1; io=ilOBwd-Xh9Z1fGzpFaM0"
      },"GET");
      const pattern = /<th>(Longitude|Latitude|Course|Speed|Position Received)<\/th>\s*<td>(.*?)<\/td>/g;
      const extractedData = {};
